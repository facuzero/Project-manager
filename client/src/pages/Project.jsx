        ...
        <>
          <div className='flex justify-between '>
            ...
            <Link
              ...
              className='flex justify-center items-center gap-2 text-black hover:text-orange-50 uppercase font-bold'
            >
              <svg
          ...
          <div className='flex justify-between'>
            ...
            <div
              className='flex justify-center items-center gap-1 text-black hover:text-orange-50 cursor-pointer'
